...
use backend\modules\compra\models\search\CompraSearch;
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Compra",
                    'content'=>'<span class="text-success">Create Compra success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
