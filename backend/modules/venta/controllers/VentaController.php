...
namespace backend\modules\venta\controllers;

use Yii;
use backend\modules\venta\models\Venta;
use backend\modules\venta\models\search\VentaSearch;
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Venta",
                    'content'=>'<span class="text-success">Create Venta success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
